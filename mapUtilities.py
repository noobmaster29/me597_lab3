...
class mapManipulator(Node):
    ...
    def make_likelihood_field(self):
        #Maps each point in environment to a probability value based on distance to nearest obstacle
        
        #Load map's image array
